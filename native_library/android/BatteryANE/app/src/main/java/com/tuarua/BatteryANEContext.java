...
public class BatteryANEContext extends FreKotlinContext implements TRActivityResultCallback, TRStateChangeCallback {
    private AndroidActivityWrapper aaw;
    private FreKotlinMainController controller;

    @SuppressWarnings("WeakerAccess")
    public BatteryANEContext(String name, FreKotlinMainController controller, String[] functions) {
